...
export const parseSchema = ({
  ...
  const parseKey = getParseKeyFn(isDocument, schema, noMongoose);
...
export const getParseKeyFn = (isDocument: boolean, schema: any, noMongoose: boolean) => {
...
export const generateTypes = ({
  ...
  sourceFile.addStatements(writer => {
    ...
    // mongoose import
    if (!noMongoose) writer.write(MONGOOSE_IMPORT);
