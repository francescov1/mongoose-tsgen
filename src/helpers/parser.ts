...
const getMainHeader = (customFilePath: string) =>
  `/* tslint:disable */\n/* eslint-disable */\n\n// ######################################## THIS FILE WAS GENERATED BY MONGOOSE-TSGEN ######################################## //\n\n// NOTE: ANY CHANGES MADE WILL BE OVERWRITTEN ON SUBSEQUENT EXECUTIONS OF MONGOOSE-TSGEN.\n// TO ADD CUSTOM INTERFACES, DEFINE THEM IN THE \`${customFilePath}\` FILE.\n\n`;
const getCustomHeader = (genFilePath: string, isModule: boolean) =>
  `/* tslint:disable */\n/* eslint-disable */\n\n// ######################################## THIS FILE WAS GENERATED BY MONGOOSE-TSGEN ######################################## //\n\n// ${
    isModule ?
      "ADD ANY CUSTOM INTERFACES OR TYPES WITHIN THE MONGOOSE MODULE DECLARATION BELOW." :
      `EXPORT ANY CUSTOM INTERFACES OR TYPES BELOW, THEY WILL BE AUTOMATICALLY EXPORTED BY ${genFilePath} FOR CONVENIENCE.`
...
export const generateFileString = ({
  ...
  let fullTemplate = getMainHeader(customFilePath);
...
const getCustomTemplate = ({
  ...
  let customTemplateString = getCustomHeader(genFilePath, isModule);
  if (isModule)
    customTemplateString += IMPORTS + MODULE_DECLARATION_HEADER + MODULE_DECLARATION_FOOTER;
...
export const writeOrCreateInterfaceFiles = ({
  ...
  const writeFiles = () => {
    ...
    if (glob.sync(customFilePath).length === 0) {
      console.log(`${customFilePath} file not found, creating...`);
      const customInterfaceString = getCustomTemplate({ genFilePath, isModule });
      fs.writeFileSync(customFilePath, customInterfaceString, "utf8");
    }
  };
